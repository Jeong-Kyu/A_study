...
model2 = KerasClassifier(build_fn=build_model, epochs=100, validation_split=0.2, verbose=1)
...
import pickle
pickle.dump(score, open('../data/xgb_save/m64.pickle.dat','wb'))
print('저장완료')

#불러오기
# model2 = pickle.load(open('../data/xgb_save/m64.pickle.dat','rb'))
# print('불러오기')
