...
scaler = MinMaxScaler()
scaler.fit(x_train)
x_train = scaler.transform(x_train).reshape(353, 10) #x_train만 trans 후 바뀐수치 x_train에 다시넣기
x_test = scaler.transform(x_test).reshape(89, 10) #x_test 따로 trans  후 바뀐수치 x_test에 다시넣기
...
modelpath = '../data/modelcheckpoint/k62_diabetes_mnist_{epoch:02d}-{val_loss:.4f}.hdf5'
...
# <tensorflow.python.keras.wrappers.scikit_learn.KerasClassifier object at 0x0000015E85735C70>
# 0.997076133886973
# 9/9 [==============================] - 0s 1ms/step - loss: 0.0029 - accuracy: 0.9971
# final score :  0.9971182942390442