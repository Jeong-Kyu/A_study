...
pred_docs = ['너무 너무 재밌어요', '재미있네요']
token.fit_on_texts(pred_docs)
pred_x = token.texts_to_sequences(pred_docs)
pred_x = pad_sequences(pred_x, padding='pre', maxlen=5)
pred_x = pred_x.reshape(2,5,1)
