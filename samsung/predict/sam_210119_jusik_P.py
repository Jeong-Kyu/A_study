...
kod=kod.to_numpy()
'''
sj = np.load('./samsung/save/data/sam_210119_sam_xy.npy')
kod = np.load('./samsung/save/data/sam_210119_kod_xy.npy')
...
model.fit([x_train, x1_train], y_train, batch_size=128, epochs=30000, validation_data=([x_val,x1_val], y_val), callbacks=[es])
'''
model=load_model('./samsung/save/samsung_fitsave/sam_210119_fitsave.h5')

result = model.evaluate([x_test,x1_test], y_test, batch_size=20)
print('loss : ', result)
