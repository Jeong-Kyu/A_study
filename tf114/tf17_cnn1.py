...
#L5
w5 = tf.get_variable('w5', shape = [2*2*64, 64], initializer= tf.contrib.keras.initializers.he_normal())    
...
#L6
w6 = tf.get_variable('w6', shape = [64, 32], initializer= tf.contrib.keras.initializers.he_normal())    
