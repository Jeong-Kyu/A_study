...
parameters = [
    ...
    {'n_estimators' : [80, 90, 100], 'learning_rate' : [0.1,0.01,0.001],
    'max_depth' : [4,5,6], 'colsample_bytree' : [0.3, 0.7, 1]}
]
...
for thresh in thresholds:
    ...
    selection_model = RandomizedSearchCV(XGBRegressor(eval_metric='mlogloss'),parameters,verbose=1)
