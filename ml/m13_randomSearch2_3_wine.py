...
# grid
# 최적의 매개변수 :  RandomForestClassifier(min_samples_split=10, n_estimators=200)
# 최종정답률 : 1.0
# scores :  [1.         0.96551724 0.96428571 0.92857143 0.96428571]
# 처리시간 :  0:02:45.120595
# random
# 최적의 매개변수 :  RandomForestClassifier(min_samples_split=3, n_estimators=200)
# 최종정답률 : 1.0
# scores :  [1.         1.         0.96428571 0.96428571 0.92857143]
# 처리시간 :  0:00:50.075516