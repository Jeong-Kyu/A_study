...
# 최종정답률 : 0.9333333333333333
# scores :  [0.95833333 0.91666667 0.91666667 0.95833333 1.        ]
# 처리시간 :  0:00:47.873493

scores = pd.DataFrame(model.cv_results_)
scores = scores[['params','mean_test_score', 'rank_test_score', 'split0_test_score','split1_test_score', 'split2_test_score']]
print(scores)