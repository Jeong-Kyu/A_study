...
from tensorflow.keras.layers import Dense, Input, LSTM, Conv1D, Dropout
model=Sequential()
model.add(Conv1D(filters=36, kernel_size=13, input_shape=(13,1)))
model.add(Dense(40))
...
# Conv1D
# loss :  7.911304473876953
# mae :  2.127732515335083