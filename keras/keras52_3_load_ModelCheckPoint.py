...
# 가중치_loss :  0.10176107287406921
# 가중치_accuracy :  0.9700999855995178

model2 = load_model('../data/modelcheckpoint/k52_1_mnist_checkpoint.hdf5')
result2 = model2.evaluate(x_test, y_test, batch_size=200)
print('로드체크포인트모델_loss : ', result2[0])
print('로드체크포인트모델_accuracy : ', result2[1])

# 로드체크포인트모델_loss :  0.09216608107089996
# 로드체크포인트모델_accuracy :  0.9725000262260437