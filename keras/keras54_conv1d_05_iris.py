...
#2. 모델링
model  = Sequential()
model.add(Conv1D(filters = 10,kernel_size=4, input_shape = (4,1)))  # (input_dim * kernel_size + bias)*filter
...
# conv1d
# [0.08500918745994568, 0.9666666388511658]

[0.12067686766386032, 0.9333333373069763]