...
x1_train, x1_test, x2_train, x2_test, y1_train, y1_test, y2_train, y2_test, y3_train, y3_test = train_test_split(x1, x2, y1, y2, y3, shuffle=False, train_size=0.8, random_state=33)
...
print("mse : ", (mean_squared_error(y1_test, y1_predict) + mean_squared_error(y2_test, y2_predict)+mean_squared_error(y3_test, y3_predict))/3)

from sklearn.metrics import r2_score
r2 = (r2_score(y1_test, y1_predict)+r2_score(y2_test, y2_predict)+r2_score(y3_test, y3_predict))/3
print("R2 : ", r2)
