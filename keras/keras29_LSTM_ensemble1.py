...
x1_train, x1_test, y1_train, y1_test, x2_train, x2_test = train_test_split(x1, y, x2, shuffle=False, train_size=0.8, random_state=33)
...
model.fit([x1_train, x2_train], y1_train, epochs=500, batch_size=13, validation_split=0.2, verbose=1)
...
# [3469.443359375, 58.34983444213867]
# [[9.362111]]