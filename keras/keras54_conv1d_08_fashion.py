...
from tensorflow.keras.layers import Dense, Conv1D, MaxPool1D,Flatten, LSTM

#2. 모델링
model  = Sequential()
model.add(Conv1D(filters=30,input_shape=(28*28,1), kernel_size=28))
model.add(Dense(10))
model.add(Dense(50))
model.add(Dense(1))
#3. 컴파일, 훈련
...
# loss :  8.25096321105957
# mae :  2.494642972946167