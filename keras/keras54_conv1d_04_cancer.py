...
from tensorflow.keras.layers import Dense, Input, LSTM, Dropout, Conv1D, MaxPool1D

model = Sequential()
model.add(Conv1D(filters=50, kernel_size=30, input_shape=(30,1))) #히든없어도 가능
model.add(Dense(100, activation='relu'))
model.add(Dropout(0.2)) 
model.add(Dense(100, activation='relu'))#히든없어도 가능
model.add(Dropout(0.2)) 
model.add(Dense(50, activation='relu'))#히든없어도 가능
...
# conv1d
# [0.4131196439266205, 0.9473684430122375]